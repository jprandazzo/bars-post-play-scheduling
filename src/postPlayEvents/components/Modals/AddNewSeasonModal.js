...
export const AddNewSeasonModal = ({
    isSeasonModalOpen,
    setSeasonModalOpen,
    newSeason = {},
    setNewSeason,
    ...
    return (
        ...
        >
            ...
            <input
                ...
                onChange={(e) =>
                    setNewSeason({ ...newSeason, sport: e.target.value })
                }
            />
            ...
            <input
                ...
                onChange={(e) =>
                    setNewSeason({ ...newSeason, dayOfWeek: e.target.value })
                }
            />
            ...
            <input
                ...
                onChange={(e) =>
                    setNewSeason({ ...newSeason, wtnbOrCoed: e.target.value })
                }
            />
            ...
            <input
                ...
                onChange={(e) =>
                    setNewSeason({ ...newSeason, weeks: e.target.value })
                }
            />
            ...
            <button type="button" onClick={() => setSeasonModalOpen(false)}>
                Cancel
            </button>
        </Modal>
    );
