    ...
    <>
      ...
      <tr key={event.id} className={event.sport}>
        ...
        <td>
          ...
          <br />
          {event.eventDate.month}/{event.eventDate.date}/{event.eventDate.year}
          <br />
          {event.eventDate.hour}:{event.eventDate.minute} {event.eventDate.amPm}
          <br />
        </td>
        ...
        <td>
          <input
            ...
            onChange={() =>
              handleCheckboxChange('isContacted', !event.isContacted)
            }
        ...
        <td>
          <input
            ...
            onChange={() =>
              handleCheckboxChange('isConfirmed', !event.isConfirmed)
            }
            disabled={!currentUser}
            title={
              !currentUser
        ...
        <td>
          <input
            ...
            onChange={() =>
              handleCheckboxChange('isPizzaNight', !event.isPizzaNight)
            }
            disabled={!currentUser}
            title={
              !currentUser
        ...
        <td>
          <input
            ...
            onChange={() =>
              handleCheckboxChange('isPizzaOrdered', !event.isPizzaOrdered)
            }
            disabled={!currentUser}
            title={
              !currentUser
        ...
        <td>
          {/* <button
                    ...
                    > */}
          <FontAwesomeIcon
            onClick={currentUser ? handleEditClick : null} // Only trigger onClick if the user is logged in
            icon={faPenToSquare}
