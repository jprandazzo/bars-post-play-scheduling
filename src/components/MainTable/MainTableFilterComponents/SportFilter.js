                    ...
                    <div className="sport-filter-menu">
                        ...
                        <div className="sport-filter-column"> Day Of Week
                            {uniqueSportDaysOfWeek.map((dayOfWeek) => (
                                <Dropdown.Item key={dayOfWeek} as="div" onClick={(e) => handleFilterCheckboxClick(e, 'selectedSportDaysOfWeek', dayOfWeek, {setUserFilters})}>
                                    <Form.Check 
                                        type="checkbox"
                                        label={dayOfWeek}
                        ...
                        <div className="sport-filter-column"> Sport
                            {sports.map((sportName) => (
                                <Dropdown.Item key={sportName} as="div" onClick={(e) => handleFilterCheckboxClick(e,'selectedSports', sportName, {setUserFilters})}>
                                    <Form.Check 
                                        type="checkbox"
                                        label={sportName}
                        ...
                        <div className="sport-filter-column"> WTNB or Coed
                            {wtnbOrCoedOptions.map((wtnbOrCoedOption) => (
                                <Dropdown.Item key={wtnbOrCoedOption} as="div" onClick={(e) => handleFilterCheckboxClick(e,'selectedWtnbOrCoed', wtnbOrCoedOption, {setUserFilters})}>
                                    <Form.Check 
                                        type="checkbox"
